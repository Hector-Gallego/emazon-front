...
describe('InputComponent', () => {
  ...
  it('debería mostrar el mensaje de error', () => {
    ...
    const errorMessageElement = fixture.debugElement.query(
      By.css('.input-container__error-message')
    );
  ...
  it('debería registrar la función onChange', () => {
    ...
    component.onInput({ target: { value: 'Nuevo valor' } } as Event & { target: {value: string }});
  ...
  it('debería registrar la función onTouched', () => {
    ...
    component.onInput({ target: { value: 'Cualquier valor' }}  as Event & {target : {value: string}});

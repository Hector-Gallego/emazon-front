...
describe('ListCategoriesComponent', () => {
  ...
  it('debería cargar las categorías al inicializar', () => {
    ...
    expect(categoryService.getCategories).toHaveBeenCalledWith(0, component.pageSize, component.sortBy, component.sortDirection);
    expect(component.categories).toEqual([{ name: 'Categoría 1', description: 'Descripción 1' }]);
